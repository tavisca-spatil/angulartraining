var Product = /** @class */ (function () {
    function Product(ProductId, ProductName, ProductCategory, Manufacturer, Description, Price) {
...
var ProductLogic = /** @class */ (function () {
    ...
    ProductLogic.prototype.addUniqueProduct = function (prod) {
    ...
    ProductLogic.prototype.deleteProductById = function (productId) {
        for (var i = 0; i < this.products.length; i++) {
...
//List all Products
productLogic.getProducts().forEach(function (p, i) {
    console.log("Product details: " + JSON.stringify(p) + " \n");
});
//List all products by (Category/Manufacturer)
productLogic.getProductsByCategory('Appliances').forEach(function (p, i) {
    console.log("Product details by Category: " + JSON.stringify(p) + " \n");
});
//Update the products (with all validations)
productLogic.addUniqueProduct(new Product(106, 'Dining Table', 'Furniture', 'Hariom Handicraft', 'Dining Table with 6 Chairs, 1 Table, 6 Seater Dining Set -Dining Room Furniture', 15000)).forEach(function (p, i) {
    console.log("Product details post adding/updating: " + JSON.stringify(p) + " \n");
});
//Delete the product by product Id
productLogic.deleteProductById(106).forEach(function (p, i) {
...
productLogic.addUniqueProduct(new Product(107, 'Table', 'Furniture', 'Hariom Handicraft', 'Dining Table with 6 Chairs, 1 Table, 6 Seater Dining Set -Dining Room Furniture', -15000)).forEach(function (p, i) {
    console.log("Product details post adding/updating: " + JSON.stringify(p) + " \n");
});
